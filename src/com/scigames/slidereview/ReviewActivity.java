...
package com.scigames.slidereview;
...
import com.scigames.slidereview.R;
import com.scigames.slidereview.ReviewActivity;
import com.scigames.slidereview.ReviewAnimationView.ReviewAnimationThread;
...
public class ReviewActivity extends Activity implements SciGamesListener{
    ...
    SciGamesHttpPoster task = new SciGamesHttpPoster(ReviewActivity.this,"http://db.scigam.es/pull/slide_results.php");
